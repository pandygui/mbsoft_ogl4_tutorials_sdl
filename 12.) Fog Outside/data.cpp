...
void LoadShaders()
{
	...
	shShaders[0].LoadShader("data\\shaders\\tut12\\shader.vert", GL_VERTEX_SHADER);
	shShaders[1].LoadShader("data\\shaders\\tut12\\shader.frag", GL_FRAGMENT_SHADER);
	...
	shShaders[5].LoadShader("data\\shaders\\tut12\\fog.frag", GL_FRAGMENT_SHADER);
